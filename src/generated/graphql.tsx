...
export type LaunchedMissionQueryVariables = Exact<{ [key: string]: never; }>;


export type LaunchedMissionQuery = (
  { __typename?: 'Query' }
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_success' | 'mission_id'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
...
export const LaunchedMissionDocument = gql`
...
/**
 * __useLaunchedMissionQuery__
 *
 * To run a query within a React component, call `useLaunchedMissionQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchedMissionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useLaunchedMissionQuery(baseOptions?: Apollo.QueryHookOptions<LaunchedMissionQuery, LaunchedMissionQueryVariables>) {
        return Apollo.useQuery<LaunchedMissionQuery, LaunchedMissionQueryVariables>(LaunchedMissionDocument, baseOptions);
      }
export function useLaunchedMissionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchedMissionQuery, LaunchedMissionQueryVariables>) {
          return Apollo.useLazyQuery<LaunchedMissionQuery, LaunchedMissionQueryVariables>(LaunchedMissionDocument, baseOptions);
        }
export type LaunchedMissionQueryHookResult = ReturnType<typeof useLaunchedMissionQuery>;
export type LaunchedMissionLazyQueryHookResult = ReturnType<typeof useLaunchedMissionLazyQuery>;
export type LaunchedMissionQueryResult = Apollo.QueryResult<LaunchedMissionQuery, LaunchedMissionQueryVariables>;
